...
#### Демонстрация работы
Исходный код лежит в `rip.py`, конфигурацию сети можно посмотреть в `network.json`. Результаты запуска:
![Initial state](images\image.png)
