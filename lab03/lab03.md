...
#### Решение
Так как $N = 10 + 1$, а скорость передачи по линии связи составляет $100$ пакетов в секунду, то средняя задержка передачи равна $0.01$ c или же $10$ мс. Тогда $d = 10 + 10 = 20$ мс. По формуле Литтла $a = \dfrac{N}{d} = 0.55$ пакетов за мс или же 550 пакетов в секунду.
