...
#### Демонстрация работы
Код можно посмотреть в файле `ping.py` по соседству

Сервер, расположенный в Бразилии:

![alt text](images/image.png)

Сервер, расположенный в Австралии:

![alt text](images/image-1.png)

Для примера вывод обычного ping:
...
#### Демонстрация работы
см. скрины с предыдущего задания
...
<img src="images/images/go-back-n.png" width=700 />
